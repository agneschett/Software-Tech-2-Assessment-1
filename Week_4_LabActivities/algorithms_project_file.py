...
sorted_list = list(range(7000000))
...
## TASK 4 
def insertion_linear_search(array, target):
    sorted_array = insertion_sort(array)
    result = linear_search(sorted_array, target)
    return result

def bubble_linear_search(array, target):
...
# TASK 4 - Measuring Execution Time
...
insertion_linear_time = timeit.timeit(
    lambda: insertion_linear_search(test_list.copy(), target), number=1)

bubble_linear_time = timeit.timeit(
    lambda: bubble_linear_search(test_list.copy(), target), number=1)

insertion_binary_time = timeit.timeit(
    lambda: insertion_binary_search(test_list.copy(), target), number=1)

bubble_binary_time = timeit.timeit(
    lambda: bubble_binary_search(test_list.copy(), target), number=1)

# Display results
print("\n--- Task 4 Execution Times ---")
print(f"Insertion Sort + Linear Search: {insertion_linear_time:.6f} seconds")
print(f"Bubble Sort + Linear Search: {bubble_linear_time:.6f} seconds")
print(f"Insertion Sort + Binary Search: {insertion_binary_time:.6f} seconds")
print(f"Bubble Sort + Binary Search: {bubble_binary_time:.6f} seconds")